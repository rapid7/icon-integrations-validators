...
class WorkflowSpellingValidator(KomandPluginValidator):
    ...
    def validate_spelling(spec):
        ...
        parsed_lst = WorkflowSpellingValidator.parse_lst(lst)
        ...
        parsed_help_lst = WorkflowSpellingValidator.parse_lst(help_lst)
    ...
    def validate(self, spec):
        WorkflowSpellingValidator.validate_spelling(spec)
