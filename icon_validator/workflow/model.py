...
class Templates:
    """
    Templates is a model thats used for managing the template development lifecycle
    """

    # TODO Create template struct
    pass
...
class Kom:
    ...
    def get_latest_workflow_version(self) -> Union[
        Type[WorkflowVersion], WorkflowVersion]:
