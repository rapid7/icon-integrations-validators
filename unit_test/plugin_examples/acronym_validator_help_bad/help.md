...
# Requirements
 ...
 This plugin require ip address md5 hash as password
...
|errors|string|nothing|False|How whois errors should be handled when decoding Base64|['replace', 'ignore', 'nothing']|ignore|
...
|Name|Type|Required|Description|
|----|----|--------|-----------|
|data|string|True|Decoded data result aws|
